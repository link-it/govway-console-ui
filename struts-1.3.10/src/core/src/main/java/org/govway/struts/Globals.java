...
public class Globals implements Serializable {
    ...
    public static final String ACTION_SERVLET_KEY =
        "org.govway.struts.action.ACTION_SERVLET";
     ...
     * @since Struts 1.1
     */
    public static final String CANCEL_KEY = "org.govway.struts.action.CANCEL";
     ...
     * @since Struts 1.1
     */
    public static final String MODULE_KEY = "org.govway.struts.action.MODULE";
    ...
    public static final String MODULE_PREFIXES_KEY =
        "org.govway.struts.globals.MODULE_PREFIXES";
    ...
    public static final String ORIGINAL_URI_KEY =
        "org.govway.struts.globals.ORIGINAL_URI_KEY";

    /**
     * The request attributes key under which your action should store an
     * <code>org.govway.struts.action.ActionErrors</code> object, if you are
     * using the corresponding custom tag library elements.
     */
    public static final String ERROR_KEY = "org.govway.struts.action.ERROR";
    ...
    public static final String EXCEPTION_KEY =
        "org.govway.struts.action.EXCEPTION";
     ...
     */
    public static final String LOCALE_KEY = "org.govway.struts.action.LOCALE";

    /**
     * The request attributes key under which our <code>org.govway.struts.ActionMapping</code>
     * instance is passed.
     */
    public static final String MAPPING_KEY =
        "org.govway.struts.action.mapping.instance";

    /**
     * The request attributes key under which your action should store an
     * <code>org.govway.struts.action.ActionMessages</code> object, if you are
     * using the corresponding custom tag library elements.
     *
     * @since Struts 1.1
     */
    public static final String MESSAGE_KEY =
        "org.govway.struts.action.ACTION_MESSAGE";
    ...
    public static final String PLUG_INS_KEY =
        "org.govway.struts.action.PLUG_INS";
    ...
    public static final String REQUEST_PROCESSOR_KEY =
        "org.govway.struts.action.REQUEST_PROCESSOR";
    ...
    public static final String SERVLET_KEY =
        "org.govway.struts.action.SERVLET_MAPPING";
    ...
    public static final String TRANSACTION_TOKEN_KEY =
        "org.govway.struts.action.TOKEN";
     ...
     * @since Struts 1.1
     */
    public static final String XHTML_KEY = "org.govway.struts.globals.XHTML";

    /**
     * The name of the taglib package.
     */
    public static final String TAGLIB_PACKAGE = "org.govway.struts.taglib.html";
