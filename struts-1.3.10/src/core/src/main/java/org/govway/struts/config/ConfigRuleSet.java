...
public class ConfigRuleSet extends RuleSetBase {
     ...
     * <code>org.govway.struts.config.ModuleConfig</code> is pushed onto the
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addSetNext("struts-config/action-mappings/action",
            "addActionConfig", "org.govway.struts.config.ActionConfig");
        ...
        digester.addSetNext("struts-config/action-mappings/action/forward",
            "addForwardConfig", "org.govway.struts.config.ForwardConfig");
        ...
        digester.addSetNext("struts-config/form-beans/form-bean",
            "addFormBeanConfig", "org.govway.struts.config.FormBeanConfig");

        digester.addObjectCreate("struts-config/form-beans/form-bean/form-property",
            "org.govway.struts.config.FormPropertyConfig", "className");
        digester.addSetProperties(
        ...
        digester.addSetNext("struts-config/form-beans/form-bean/form-property",
            ...
            "org.govway.struts.config.FormPropertyConfig");
        ...
        digester.addObjectCreate("struts-config/message-resources",
            "org.govway.struts.config.MessageResourcesConfig", "className");
 ...
 * which must be a <code>org.govway.struts.config.ModuleConfig</code>. </p>
 */
 ...
 * top of the stack, which must be a <code>org.govway.struts.config.ModuleConfig</code>.
 * </p>
 */
